...
function Modal({ isModalOpen, onClose, modalNum, className }) {
        ...
        return (
          <div className="link-list-modal">
            <ul>
              <li>
                <a
                  href="https://m.entertain.naver.com/home"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://sports.news.naver.com/index"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  스포츠
        ...
        return (
          <div className="link-list-modal">
            <ul>
              ...
              <li>
                <a
                  href="https://www.oliveyoung.co.kr"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  올리브영
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        <div className="modal-body">{Modallist(modalNum)}</div>
      </div>
    </div>
  );
}
